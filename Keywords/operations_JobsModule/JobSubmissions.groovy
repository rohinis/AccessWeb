...
public class JobSubmissions {
	...
	def JSAllFileds(String toChange,String ChangeValue,extentTest) {
		...
		switch (toChange) {
			...
			case 'NCPU':
				WebUI.click(findTestObject('JobSubmissionForm/List_NFCORES'))
				WebUI.setText(findTestObject('JobSubmissionForm/List_NFCORES'),ChangeValue)
				extentTest.log(Status.PASS, 'Changed the No.of Cores value to - '+ChangeValue)
				break
			...
			//	WebUI.sendKeys(findTestObject('Object Repository/FilesPage/textBx_FilePath'), Keys.chord(Keys.ENTER))
				...
				WebUI.waitForElementPresent(findTestObject('FilesPage/btn_NewFileFolder'), 10)
				WebUI.click(findTestObject('FilesPage/btn_NewFileFolder'))
				WebUI.click(findTestObject('FilesPage/ListItem_Folder'))
				WebUI.waitForElementPresent(findTestObject('FilesPage/TextBxFolder_input'), 5)
	...
	def selectFile(String mode , String InputFile,extentTest){
		...
		switch (mode){
			case 'Local':
				...
				WebUI.delay(2)
				WebUI.waitForElementPresent(findTestObject('Object Repository/FilesPage/gotofoldertext'), 10)
			...
			//def FolderEmptytext = (new customWait.WaitForElement()).WaitForelementPresent(findTestObject('Object Repository/FilesPage/Label_FolderEmpty'), 3,extentTest,'Lable Empty')
				def FolderEmptytext =	WebUI.waitForElementPresent(findTestObject('Object Repository/FilesPage/Label_FolderEmpty'), 5)
				println(FolderEmptytext)
				if (FolderEmptytext) {
					println('FolderEmptytext')
				}
				else {
					WebUI.waitForElementPresent(findTestObject('Object Repository/FilesPage/CheckBox_SelectAll-JS-RFB'), 10)
					...
					/*def ele=	WebUI.waitForElementClickable(findTestObject('Object Repository/FilesPage/Icon_DeleteIcon_Fileop'), 15)
				 println('===============================')
				 println(ele)
				 println('===============================')
				 //WebUI.delay(2)
				 ...
				 WebUI.click(findTestObject('GenericObjects/btn_Yes'))*/
					WebUI.delay(2)
					WebElement deleteBtn= driver.findElement(By.xpath("//span[@id = 'delete_icon']"))
					JavascriptExecutor jse1 = (JavascriptExecutor)driver;
					jse1.executeScript("arguments[0].click()", deleteBtn);
					WebUI.delay(5)
					WebUI.click(findTestObject('GenericObjects/btn_Yes'))
				}
			...
			/*WebUI.click(findTestObject('Object Repository/FilesPage/GotoFoldericon'))
			 ...
			 extentTest.log(Status.PASS, 'Navigated to '+ fileLocation +'in RFB ')*/
				(new generateFilePath.filePath()).navlocation(fileLocation, extentTest)
				WebUI.delay(5)
				WebUI.verifyElementPresent(findTestObject('Object Repository/JobSubmissionForm/textBx_file_filter'), 15)
			...
			/*def FileUploadClose = (new customWait.WaitForElement()).WaitForelementPresent(findTestObject('Object Repository/JobSubmissionForm/Icon_Close_UploadNotification'), 20,extentTest,'Upload panel close icon')
			 ...
			 WebUI.click(findTestObject('Object Repository/JobSubmissionForm/Icon_Close_UploadNotification'))
				...
				WebUI.delay(2)
				WebElement closeNotification= driver.findElement(By.xpath("//span[@class='header-close unity_close']"))
				JavascriptExecutor jse1 = (JavascriptExecutor)driver;
				jse1.executeScript("arguments[0].click()", closeNotification);
