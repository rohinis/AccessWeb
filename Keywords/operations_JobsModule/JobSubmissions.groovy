	...
	def selectFile(String mode , String InputFile,extentTest){
		...
		switch (mode){
			case 'Local':
				...
				def FolderEmptytext = (new customWait.WaitForElement()).WaitForelementPresent(findTestObject('Object Repository/FilesPage/Label_FolderEmpty'), 20,extentTest,'Lable Empty')
