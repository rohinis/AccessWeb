	...
	def multiFileOperations(String Operation,String TestCaseName ,extentTest,katalonWebDriver) {
		...
		switch (Operation) {
			...
			if (TestCaseName.contains('tile view')) {
				...
				newFolderObj.addProperty('xpath', ConditionType.EQUALS, "//label[contains(text(),'MultipleFiles')]")
				...
				WebUI.click(newFolderObj)
				WebUI.doubleClick(newFolderObj)
				extentTest.log(LogStatus.PASS, 'Navigated to '+GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFiles/CopyPasteTV')
				WebUI.delay(2)
				y=5
				msg = '5 items copied successfully to'+ GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFiles/CopyPasteTV'
			}
			else {

				TestObject newFolderObj
				newFolderObj=new TestObject('objectName')
				newFolderObj.addProperty('xpath', ConditionType.EQUALS, "//div[@title = 'MultipleFiles']")
				WebUI.click(findTestObject('Object Repository/FilesPage/link_BaseFolder'))
				WebUI.delay(2)
				WebUI.click(newFolderObj)
				WebUI.doubleClick(newFolderObj)
				...
				WebUI.click(newFolderObj)
				WebUI.doubleClick(newFolderObj)
				extentTest.log(LogStatus.PASS, 'Navigated to '+GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFiles/CopyPasteLV')
				WebUI.delay(2)
				y=6
				msg = '5 items copied successfully to'+ GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFiles/CopyPasteLV'
			}
			...
			if (TestCaseName.contains('tile view')) {
				...
				WebUI.click(newFolderObj)
				WebUI.doubleClick(newFolderObj)
				extentTest.log(LogStatus.PASS, 'Navigated to '+GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFiles/CutPasteTV')
				WebUI.delay(2)
				y=5
				msg = '5 items moved successfully to'+ GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFiles/CutPasteTV'
			}
			else {
				...
				WebUI.click(newFolderObj)
				WebUI.doubleClick(newFolderObj)
				extentTest.log(LogStatus.PASS, 'Navigated to '+GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFiles/CutPasteLV')
				WebUI.delay(2)
				y=6
				msg = '5 items moved successfully to'+ GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFiles/CutPasteLV'
			}
