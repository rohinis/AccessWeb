		...
		switch (Operation) {
			case 'copy_icon':
				...
				if (TestCaseName.contains('tile view')) {
					...
					newFolderObj.addProperty('xpath', ConditionType.EQUALS, "//label[contains(text(),'MultipleFilesIcons')]")
					...
					WebUI.click(newFolderObj)
					WebUI.doubleClick(newFolderObj)
					extentTest.log(LogStatus.PASS, 'Navigated to '+GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFilesIcons/CopyPasteTV')
					WebUI.delay(2)
					y=5
					msg = '5 items copied successfully to'+ GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFilesIcons/CopyPasteTV'
				}
				else {

					TestObject newFolderObj
					newFolderObj=new TestObject('objectName')
					newFolderObj.addProperty('xpath', ConditionType.EQUALS, "//div[@title = 'MultipleFilesIcons']")
					WebUI.click(findTestObject('Object Repository/FilesPage/link_BaseFolder'))
					WebUI.delay(2)
					WebUI.click(newFolderObj)
					WebUI.doubleClick(newFolderObj)
					...
					WebUI.click(newFolderObj)
					WebUI.doubleClick(newFolderObj)
					extentTest.log(LogStatus.PASS, 'Navigated to '+GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFilesIcons/CopyPasteLV')
					WebUI.delay(2)
					y=6
					msg = '5 items copied successfully to'+ GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFilesIcons/CopyPasteLV'
				}
			...
			case 'cut_icon':
				...
				if (TestCaseName.contains('tile view')) {
					...
					WebUI.click(newFolderObj)
					WebUI.doubleClick(newFolderObj)
					extentTest.log(LogStatus.PASS, 'Navigated to '+GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFilesIcons/CutPasteTV')
					WebUI.delay(2)
					y=5
					msg = '5 items moved successfully to'+ GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFilesIcons/CutPasteTV'
				}
				else {
					...
					WebUI.click(newFolderObj)
					WebUI.doubleClick(newFolderObj)
					extentTest.log(LogStatus.PASS, 'Navigated to '+GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFilesIcons/CutPasteLV')
					WebUI.delay(2)
					y=6
					msg = '5 items moved successfully to'+ GlobalVariable.G_StageArea+'/'+GlobalVariable.G_userName+'/MultipleFilesIcons/CutPasteLV'
				}
