...
class notifications {
	...
	@Keyword
	def getNotificationsText(extentTest,katalonWebDriver) {

		String myXpath ="//span[@class = 'block notification-popup-message']"
		WebElement ele = katalonWebDriver.findElement(By.xpath(myXpath))
		String notificationMsg=ele.getAttribute('textContent')
		println("===========================================================")
		println("===========================================================")
