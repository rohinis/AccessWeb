...
try {
	...
	WebUI.waitForElementPresent(findTestObject('FilesPage/btn_NewFileFolder'), 5)
	...
	WebUI.waitForElementPresent(findTestObject('FilesPage/TextBx_CreateFile'), 5)
	...
	CustomKeywords.'operations_FileModule.notifications.getNotificationsText'(extentTest,katalonWebDriver)
	...
	switch (userChoice) {
		...
		//WebUI.delay(2)
			TestObject createFileNotification = CustomKeywords.'buildTestObj.CreateTestObjFiles.myTestObjFileCreateNotification'(
					fileName)
		...
		//WebUI.delay(2)
			TestObject createFolderErrorNotification = CustomKeywords.'buildTestObj.CreateTestObjFiles.myTestObjFolderCreateErrorNotification'(
					fileName)
