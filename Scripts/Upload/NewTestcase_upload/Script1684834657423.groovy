...
try {
	...
	switch (UserChoice) {
		...
		case 'FileUpload':
			  ...
			  def value1=WebUI.verifyElementPresent(findTestObject('Object Repository/FilesPage/Uploadbtn_Folder'),10)
			  def value2=WebUI.verifyElementPresent(findTestObject('Object Repository/FilesPage/Uploadbtn_File'),10)
			  if(value1&&value2) {
		...
		case 'JSUpload':
			  ...
			  WebUI.delay(2)
				  ...
				  def value1=WebUI.waitForElementPresent(findTestObject('Object Repository/FilesPage/Uploadbtn_Folder'),10)
				  def value2=WebUI.waitForElementPresent(findTestObject('Object Repository/FilesPage/Uploadbtn_File'),10)
				  if(value1&&value2) {
					  extentTest.log(Status.PASS," user is able to view two options when user clicks on upload button- Folder and File")
				  }
				  else {
		 ...
		 //WebUI.waitForElementPresent(findTestObject('JobMonitoringPage/OutputFolder_File'), 5)
		 ...
		 if (TestCaseName.contains('context'))
		 {
			 ...
			 WebUI.waitForElementPresent(findTestObject('Object Repository/JobDetailsPage/upload_button_Runningtab'),10)
		   ...
		   extentTest.log(Status.PASS,'    AD-5036---Upload File/Folder options in Running Folder tab  Section - verify that two options are available for upload file and folder separately')
			 ...
			 def value1=WebUI.waitForElementPresent(findTestObject('Object Repository/JobDetailsPage/uploadbtn_File_Runningtab'),10)
			 def value2=WebUI.waitForElementPresent(findTestObject('Object Repository/JobDetailsPage/uploadbtn_Folder_Runningtab'),10)
			 if(value1&&value2) {
				 extentTest.log(Status.PASS," user is able to view two options when user clicks on upload button- Folder and File")
			 }
			 else {
