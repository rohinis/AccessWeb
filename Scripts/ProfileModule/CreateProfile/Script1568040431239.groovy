...
try
{
	...
	WebUI.scrollToElement(findTestObject('JobSubmissionForm/List_NFCORES'), 3)
	WebUI.setText(findTestObject('JobSubmissionForm/List_NFCORES'), '2')
	...
	switch(ProfileType)
	{
		...
		case 'Remote':
			...
			WebUI.verifyElementPresent(findTestObject('Object Repository/JobSubmissionForm/textBx_file_filter'), 5)
			...
			TestObject newFileObj = WebUI.modifyObjectProperty(findTestObject('JobSubmissionForm/File_InputFile'), 'data-automation-id', 'equals',RemoteFile, true)
