...
try {
	...
	for(int i=0;i<3;i++)
	{
		...
		TestObject newFileObj = WebUI.modifyObjectProperty(findTestObject('JobSubmissionForm/File_InputFile'), 'data-automation-id', 'equals','RunJobPython.py', true)
	...
	//	WebUI.click(findTestObject('Object Repository/JobSubmissionForm/Icon_Close_LeavePage'))
		WebUI.waitForElementPresent(findTestObject('LoginPage/NewJobPage/AppList_ShellScript'), 5)
