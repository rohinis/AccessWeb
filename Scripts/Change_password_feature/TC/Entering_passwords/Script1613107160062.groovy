...
WebUI.callTestCase(findTestCase('Generic/Login'), [('username') : GlobalVariable.G_userName, ('password') : GlobalVariable.G_Password], 
	...
	if (oldpasswd == "blank"&& newpassword =="blank" && confirmpassword == "blank" ) {
		WebUI.delay(1)
			WebUI.setText(findTestObject('Object Repository/change_password/oldpasswd'), "   ")
			WebUI.delay(1)
			WebUI.setText(findTestObject('Object Repository/change_password/newpasswd'),"    " )
			WebUI.delay(1)
			WebUI.setText(findTestObject('Object Repository/change_password/confrmpasswd'), "    ")
			WebUI.delay(1)
