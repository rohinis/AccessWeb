...
def location='/stage/'+GlobalVariable.G_userName+'/JobsModuleFolderops/'
...
def result=CustomKeywords.'jobActions.folderOperations.executeFileOperations'(Operation, TestCaseName , extentTest)
